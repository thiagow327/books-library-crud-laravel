...
class BookWebUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'isbn' => 'sometimes|required|string|max:255|unique:books,isbn,' . $this->route('book'),
            'quantity_pages' => 'sometimes|required|integer',
